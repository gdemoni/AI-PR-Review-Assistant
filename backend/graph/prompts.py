...
# ============================================================
COMPREHENSIVE_PROMPT = """你是一位资深全栈代码审查专家。请一次性从安全、性能、质量三个维度审查以下代码。所有输出必须使用中文。
...
# Critic Agent — 快速质量复核
# ============================================================
CRITIC_PROMPT = """快速复核以下审查结果。所有输出必须使用中文。
...
# Aggregator — 汇总去重排序评分
# ============================================================
AGGREGATE_PROMPT = """你是一位最终决策专家。请整合四个 Agent 的分析结果，生成统一评分。所有输出必须使用中文。
